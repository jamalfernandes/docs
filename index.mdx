...
<Steps>
  ...
  <Step title="Stay honest" icon="shield-check">
    You publish under your own name — it is your reputation. What we put forward: **verified tenant files**, the **business network**, the **founder rate**, plus the time saved and the confidence gained.

...
<Steps>
  ...
  <Step title="Reste honnête" icon="shield-check">
    Tu publies à ton nom, c'est ta réputation. On met en avant les **dossiers locataires vérifiés**, le **réseau d'affaires**, le **gain de temps** et le **gain de confiance**.

    On ne promet jamais un logiciel qui fait tout : les fonctions se déploient par vagues.
  </Step>
